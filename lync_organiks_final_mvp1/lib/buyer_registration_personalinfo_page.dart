...
class BuyerRegistrationPersonalInfoPage extends StatefulWidget {
  final String mobilenumber;
  final String role;

  BuyerRegistrationPersonalInfoPage({required this.mobilenumber, required this.role});

  @override
  _BuyerRegistrationPersonalInfoPageState createState() => _BuyerRegistrationPersonalInfoPageState();
}

class _BuyerRegistrationPersonalInfoPageState extends State<BuyerRegistrationPersonalInfoPage> {
    ...
    Future<void> submitPersonalInfo() async {
      ...
      try {
        ...
        if (response.statusCode == 201) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => CompleteprofilePage(username: name,address: address,mobilenumber: mobilenumber,uid: uid, role: role,)),
          );
        } else {
